...
export interface GetEtsyShopByOwnerUserIdResponse {
 ...
 * @returns Shop details as a promise of GetEtsyShopByOwnerUserIdResponse.
 */
export function getEtsyShopByOwnerUserId(apiKey: string, accessToken: string, userId: number) {
  return axios.get<GetEtsyShopByOwnerUserIdResponse>(
